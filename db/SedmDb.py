...
class SedmDB:
	...
	def add_observation_fits(fitsfile):
	     '''
	...
	def cancel_scheduled_request(requestid):
	     '''
	...
	def update_scheduled_request(requestid):
	     '''
	...
	def cancel_scheduled_between(initime, endtime):
	     '''
	...
	def add_reduced_photometry(pardic):
	     '''
	...
	def add_reduced_spectrum(pardic):
	     '''
